      ...
      >
        <div className="headerList">
          ...
          <div className="headerListItem">
            ...
            <span>Taxis d'aéroport</span>
          </div>
        </div>
        {type !== "list" && (
          <>
            <h1 className="headerTitle">Votre maison n'importe où</h1>
            <p className="headerDesc">
              Recherchez des offres sur des hôtels, des hébergements
              indépendants et plus encore vous êtes sur le bon site
            </p>
            {/* {!user && (
